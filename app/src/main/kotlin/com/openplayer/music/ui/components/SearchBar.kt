    ...
    Surface(
        ...
        Text(
            ...
            modifier = Modifier
                ...
                .let { mod ->
                    // Padding interno horizontal de 16dp
                    mod.then(Modifier.padding(horizontal = 16.dp))
                }
        )
    }
}

// Necesitamos el import de padding
private fun Modifier.padding(horizontal: androidx.compose.ui.unit.Dp): Modifier =
    this.then(androidx.compose.foundation.layout.padding(horizontal = horizontal))